...
*/
        ...
        _generateHTMLMinutes: function (inst) {
            ...
            if (onMinuteShow &&
                (onMinuteShow.apply((inst.input ? inst.input[0] : null), [inst.hours , inst.minutes, this._get(inst, 'targetName')]) == false) ) {
                // loop minutes and select first available
                for (minuteCounter = 0; minuteCounter < minutes.length; minuteCounter += 1) {
                    m = minutes[minuteCounter];
                    if (onMinuteShow.apply((inst.input ? inst.input[0] : null), [inst.hours, m, this._get(inst, 'targetName')])) {
                        inst.minutes = m;
                        break;
                    }
                }
        ...
        _generateHTMLHourCell: function (inst, hour, showPeriod, showLeadingZero) {
            ...
            if (onHourShow) {
            	enabled = onHourShow.apply((inst.input ? inst.input[0] : null), [hour, this._get(inst, 'targetName')]);
            }
        ...
        _generateHTMLMinuteCell: function (inst, minute, displayText) {
             ...
             if (onMinuteShow) {
             	...
             	enabled = onMinuteShow.apply((inst.input ? inst.input[0] : null), [inst.hours,minute, this._get(inst, 'targetName')]);		//trigger callback
             }
        ...
        */
        ...
        _getParsedTime: function(inst) {
			...
			if (inst.input.attr("name") == 'start') parsedTime += ':00';
			else parsedTime += ':59';
