...
{
	if(SENSOR_MODE == 0){		
		SetOptionValue('shutter_min_highFps', 14, '1/60');	// 1/50  => 1/60
		SetOptionValue('shutter_max_highFps', 14, '1/60');	// 1/50  => 1/60
	}else if(SENSOR_MODE == 1){		
		SetOptionValue('shutter_min_highFps', 14, '1/50'); // 1/60  => 1/50
		SetOptionValue('shutter_max_highFps', 14, '1/50'); // 1/60  => 1/50
	...
	if(!isOnloading){
		if (SENSOR_MODE == 0 || SENSOR_MODE == 1) {	// 60fps, 50fps	
			$('#shutter_min_highFps').val(14);
			$('#shutter_max_highFps').val(33);		// 1/11000
		}else{
	...
	<?php 
		if($event_name != 'presetedit') {
			$shutterspeedLowFps = array("x60", "x48", "x40", "x32", "x24", "x20", "x16", "x14", "x12", "x10", "x8", "x6", "x4", "x2",
										 "1/25", "1/50", "1/60", "1/100", "1/120", "1/150", "1/180", "1/200", "1/240", "1/250", "1/300",
										 "1/360", "1/480", "1/500", "1/600", "1/700", "1/1000", "1/1500", "1/2500", "1/5000", "1/10000",
										 "1/11000", "1/16000", "1/33000");
			$shutterspeedHighFps = array("x60", "x48", "x40", "x32", "x24", "x20", "x16", "x14", "x12", "x10", "x8", "x6", "x4", "x2",
										 "1/50", "1/100", "1/120", "1/150", "1/180", "1/200", "1/240", "1/250", "1/300",
										 "1/360", "1/480", "1/500", "1/600", "1/700", "1/1000", "1/1500", "1/2500", "1/5000", "1/10000",
										 "1/11000", "1/16000", "1/33000");
	?>		
		<tr>
