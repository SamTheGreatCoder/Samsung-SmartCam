...
$event_class	= $classInstances['TamperingConfiguration'];
?>
		...
		?>
			<div id="contents"  style="width:680px;">				
				<div class="h3_tit mgt0">
					<h3 class="wid320"><?php echo $menu_tamperingdetection[$GLOBALS['LANGINDEX']]; ?></h3>
				</div>
				<table class="data_write" >
					...
					<tbody>
						...
						<tr>
							<th scope="row"><?php echo $t_sensitivity[$GLOBALS['LANGINDEX']]; ?></th>
							<td>
								<select id="event_<?php echo $event_name; ?>_sensitivity" class="selectbox_style">
									<?php if($GLOBALS['M_ISP_TYPE'] == ISP_TYPE_WN2_PTZ) { ?> 
									<option value="0" <?php if ($event_class->dataInfo['Sensitivity']['value']==0) echo "selected=\"selected\""; ?>><?php echo $t_very_low[$GLOBALS['LANGINDEX']]; ?></option>
									<?php } ?>
									<option value="1" <?php if ($event_class->dataInfo['Sensitivity']['value']==1) echo "selected=\"selected\""; ?>><?php echo $t_low[$GLOBALS['LANGINDEX']]; ?></option>
									<option value="2" <?php if ($event_class->dataInfo['Sensitivity']['value']==2) echo "selected=\"selected\""; ?>><?php echo $t_normal[$GLOBALS['LANGINDEX']]; ?></option>
									<option value="3" <?php if ($event_class->dataInfo['Sensitivity']['value']==3) echo "selected=\"selected\""; ?>><?php echo $t_high[$GLOBALS['LANGINDEX']]; ?></option>
									<?php if($GLOBALS['M_ISP_TYPE'] == ISP_TYPE_WN2_PTZ) { ?> 
									<option value="4" <?php if ($event_class->dataInfo['Sensitivity']['value']==4) echo "selected=\"selected\""; ?>><?php echo $t_very_high[$GLOBALS['LANGINDEX']]; ?></option>
									<?php } ?>
								</select>
							</td>
						</tr>
