...
$videosrcclassInstances = GetClassInstance('videosrc');
$mediaconfigurationconf = $videosrcclassInstances['MediaConfiguration'];
		...
		?>
			<div id="contents"  style="width:680px;">
				...
				?>
					...
					?>
							...
							<tr>
								<th></th>
								<td>							
									<label><input type="radio" name="event_<?php echo $event_name; ?>_mode" id="event_<?php echo $event_name; ?>_mode_mdva" value="2" onClick="OnClickVaMode('mdva')" <?php if ($classInstances['VAConfiguration']->dataInfo['Mode']['value'] == 2) echo "checked=\"checked\""; ?> style="margin-left:<?php if (GetBrowserName()=='IE') {echo '-4';} else { echo '-1'; } ?>px"/><?php echo $t_md_va[$GLOBALS['LANGINDEX']]; ?></label>
								</td>
							</tr>
					<?php
						}
				...
				<?php
					...
					require_once('./event_setup/event_va_box.cgi');
