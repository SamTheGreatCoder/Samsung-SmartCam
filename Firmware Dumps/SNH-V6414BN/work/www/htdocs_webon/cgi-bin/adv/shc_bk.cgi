...
if ($_REQUEST['msubmenu'] == 'speaker') {
	...
	$interfacesExtensionConf->interfaceExtension[1]->dataInfo['InterfaceToken']['value'] = $networkV2Conf->interface[1]->dataInfo['Token']['value'];
 	
	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dataInfo['SSID']['value'] = $_REQUEST['ssid'];
	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dataInfo['Mode']['value'] = MODE_INFRASTRUCTURE;
	if ($_REQUEST['mode'] == 'NONE' || $_REQUEST['mode'] == 'none')
	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dot11SecurityConf->dataInfo['Mode']['value'] = MODE_NONE;
	if ($_REQUEST['mode'] == 'WEP' || $_REQUEST['mode'] == 'wep')
	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dot11SecurityConf->dataInfo['Mode']['value'] = MODE_WEP;
	if ($_REQUEST['mode'] == 'WPA' || $_REQUEST['mode'] == 'wpa')
	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dot11SecurityConf->dataInfo['Mode']['value'] = MODE_WPA;

	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dot11SecurityConf->dataInfo['PSK']['value'] = $_REQUEST['password'];
	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dot11SecurityConf->payload = MakePayload($interfacesExtensionConf->interfaceExtension[1]->dot11Conf->dot11SecurityConf->dataInfo);
	$interfacesExtensionConf->interfaceExtension[1]->dot11Conf->SetPayload();
	$interfacesExtensionConf->interfaceExtension[1]->SetPayload();
